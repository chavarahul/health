...
import { Pacifico, Poppins ,Roboto ,Rubik_Vinyl,Della_Respira ,Rubik_Iso, Rubik_Burned,Arvo} from 'next/font/google'
//Font Section
export const pacifico : NextFont = Pacifico({ subsets: ['latin'], weight: '400' })
export const arvo : NextFont = Pacifico({ subsets: ['latin'], weight: ['400'] })
